...
3. Write no code comments. Names carry the meaning. Rationale goes in the commit body.
   Documentation is not a comment: module and item documentation is required where the
   specification asks for it, and it describes what a thing is rather than why a line
   exists.
