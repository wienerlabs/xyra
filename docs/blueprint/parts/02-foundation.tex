...
ISC, Zlib, Unlicense or CC0. It excludes GPL and LGPL in linked form, and it treats MPL~2.0
as conditionally acceptable because its copyleft is file scoped rather than project scoped.
...
\midrule
\multicolumn{3}{@{}l}{\textit{Conditional}}\\
nucleo & MPL-2.0 & Fuzzy matching. File scoped copyleft. Acceptable if unmodified, otherwise replace with an MIT matcher. \\
\bottomrule
